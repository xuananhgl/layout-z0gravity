    ...
    $(".sp4").text(event.pageX);
                        ...
                        <div class="header_container">
                            ...
                            <p id="aa"></p>
                                ...
                                var courseApi ='http://localhost:8765/interfaces.json';
                                function start(){
        ...
        <div class="slide_box1"></div>
            ...
            var presApi ='http://localhost:8765/interfaces.json';
            function start(){
                   getPre(renderPres);
                   createPres();
                   editPres();
            ...
            function renderPres(pre){
             console.log(pre);
                 document.getElementById("demo3").innerHTML = pre.pres.id;
                 document.getElementById("demo2").innerHTML = pre.pres._translations.vi_VN.title_pres;
                 document.getElementById("demo1").innerHTML = pre.pres._translations.vi_VN.about_pres;
                 document.getElementById("demo4").innerHTML = pre.pres._translations.vi_VN.author;
                 document.getElementById("demo5").innerHTML = pre.pres._translations.vi_VN.dress;
                 document.getElementById("demo6").innerHTML = pre.pres.link;
            ...
            presBtn.onclick =function(){
               ...
               var data = {
                   ...
                   var url = 'http://localhost:8765/interfaces/.json';
               postPres(url, data);
            }
            }
            async function postPres(url, data) {
             ...
             async function deletePres(id) {
                   ...
                   console.log(id);
                   var url = 'http://localhost:8765/interfaces/'+ id +'.json';
                   const response = await fetch(url, {
                   method: 'DELETE',
                   headers: {
                     'Content-Type': 'application/json'
